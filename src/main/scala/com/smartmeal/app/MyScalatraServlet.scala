...
object MyLPProblem {
   def solve(breakfast: Int, lunch: Int, dinner: Int) =  {
      ...
      val primary = Array("Pancake", "Pancake", "Pancake", "Waffle", "Waffle", "Waffle", "Donut", "Toast", "Toast", "", "", "Croissant", "Croissant", "", "Bagel", "Bagel", "", "Orange Juice", "Milk", "Milk", "Oatmeal", "Cereal", "Cereal", "Cereal", "Cereal", "Cereal", "Cereal", "Egg", "Egg", "Egg", "Apple", "Banana", "Mixed Fruit", "Plain Yogurt", "Cheese", "Cheese", "Toast", "Cheese Sandwitch", "", "", "Hot Dog", "Hot Dog", "", "Pizza", "Pizza", "Ham", "Fried Chicken", "Buffalo Wings", "French Fries", "Hamburger", "Cheeseburger", "Mashed Potatoes", "Caesar Salad", "Asparagus", "", "Roasted Vegetables", "Rice", "Rice", "Orange Juice", "Apple Juice", "Steak")
      val second  = Array("", "Maple Syrup", "Butter", "", "Maple Syrup", "Butter", "", "", "Butter, Jam", "", "", "", "Nutela", "", "Cream Cheese", "", "", "", "Whole", "Skim", "", "Frosted Flakes", "Lucky Charmes", "Specieal K", "Honey Nut Cheerios", "Cocoa Puffs", "Cinnamon Toast Crunch", "Omelette", "Scrambled", "Fried", "", "", "", "", "Cheddar", "Swiss", "", "", "", "", "Ketchup", "", "", "Cheese", "Pepperoni", "", "", "", "", "", "", "", "", "", "", "", "Fried", "White", "", "", "")
      val mip = MIPSolver()
      ...
      (temp filter ( _._2 == 1.0)) map {case (k,v) => (primary(k).concat(" ").concat(second(k)), cal(k).toString, carb(k).toString, sugar(k).toString, fat(k).toString, prot(k).toString, calcium(k).toString)}
